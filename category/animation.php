    ...
    <div class="content">
        <div class="label-container">
            <div class="label-header">
                ...
                <div class="label-text">ANIMATION</div> 
            ...
            <div class="label-content">
                ...
                <a class="centered-video" href="../project/borealis">
                    <video class="galleryImage" width="300" height="300" autoplay muted loop playsinline>
                ...
                <a class="centered-video" href="../project/drawingdavid">
                    <video class="galleryImage" width="300" height="300" autoplay muted loop playsinline>
                ...
                <a class="centered-video" href="../project/scor">
                    <video class="galleryImage" width="300" height="300" autoplay muted loop playsinline>
